...
function Gladdy:isFeignDeath(unit)
    -- Ascension compatibility: Don't use AuraUtil.FindAuraByName - it's native and strict
    -- Scan auras manually with UnitAura (3.3.5 compatible)
